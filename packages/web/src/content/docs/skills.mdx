...
- Project config: `.nanogpt/skill/<name>/SKILL.md`
- Global config: `~/.nanogpt/skill/<name>/SKILL.md`
...
It loads any matching `skill/*/SKILL.md` in `.nanogpt/` and any matching `.claude/skills/*/SKILL.md` along the way.

Global definitions are also loaded from `~/.nanogpt/skill/*/SKILL.md`.
