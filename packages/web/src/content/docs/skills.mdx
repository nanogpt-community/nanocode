...
- Project config: `.nanocode/skill/<name>/SKILL.md`
- Global config: `~/.nanocode/skill/<name>/SKILL.md`
...
It loads any matching `skill/*/SKILL.md` in `.nanocode/` and any matching `.claude/skills/*/SKILL.md` along the way.

Global definitions are also loaded from `~/.nanocode/skill/*/SKILL.md` and `~/.claude/skills/*/SKILL.md`.
...
Create `.nanogpt/skill/git-release/SKILL.md` like this:
