---
title: TUI
description: Using the NanoCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NanoCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running NanoCode starts the TUI for the current directory.
...
When using the NanoCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to NanoCode. Allows you to select from available providers and add their API keys.
...
Exit NanoCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your NanoCode config file.
