...
Place your global OpenCode config in `~/.config/nanogpt/nanogpt.json`. You'll want to use the global config for things like themes, providers, or keybinds.
...
You can also define agents using markdown files in `~/.config/nanogpt/agent/` or `.nanogpt/agent/`. [Learn more here](/docs/agents).
...
You can also define commands using markdown files in `~/.config/nanogpt/command/` or `.nanogpt/command/`. [Learn more here](/docs/commands).
