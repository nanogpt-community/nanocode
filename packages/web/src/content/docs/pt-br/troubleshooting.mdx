...
Se você tiver `NANOGPT_PORT` definido em seu ambiente, o aplicativo de desktop tentará usar essa porta para o servidor local.

- Desfaça `NANOGPT_PORT` (ou escolha uma porta livre) e reinicie.
