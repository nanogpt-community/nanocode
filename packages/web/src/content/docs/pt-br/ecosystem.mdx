...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Agende trabalhos recorrentes usando launchd (Mac) ou systemd (Linux) com sintaxe cron                                          |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar opencode via @nanogpt/sdk                  |
...
| [OpenWork](https://github.com/different/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo opencode     |
