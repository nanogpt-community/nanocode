...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Planirajte ponavljajuće poslove koristeći launchd (Mac) ili systemd (Linux) sa cron sintaksom                 |     | [micode](https://github.com/vtemian/micode)                         | Strukturirana Brainstorm → Plan → Implementacija toka rada uz kontinuitet sesije |
...
| [OpenWork](https://github.com/different/openwork)                                       | Alternativa otvorenog koda Claudeu Coworku, pokretana pomoću OpenCode |
