...
3. **Prilagođena konfiguracija** (`NANOGPT_CONFIG` env var) - prilagođena zaobilaženja
...
6. **Inline config** (`NANOGPT_CONFIG_CONTENT` env var) - runtime nadjačava
...
Navedite prilagođeni konfiguracijski direktorij koristeći `NANOGPT_CONFIG_DIR`
