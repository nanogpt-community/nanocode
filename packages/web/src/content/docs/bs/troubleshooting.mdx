...
Ako ste postavili `NANOGPT_PORT` u svom okruženju, desktop aplikacija će pokušati da koristi taj port za lokalni server.

- Poništite `NANOGPT_PORT` (ili odaberite slobodan port) i ponovo pokrenite.
