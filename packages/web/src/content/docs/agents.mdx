...
- Global: `~/.config/nanogpt/agent/`
- Per-project: `.nanogpt/agent/`

```markdown title="~/.config/nanogpt/agent/review.md"
---
...
```markdown title="~/.config/nanogpt/agent/docs-writer.md"
---
...
```markdown title="~/.config/nanogpt/agent/security-auditor.md"
---
