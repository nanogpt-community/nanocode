...
1. Run the `/connect` command in the TUI, select opencode, and head to [nanocode.ai/auth](https://nanocode.ai/auth).
...
```jsonc title="~/.config/nanogpt/nanogpt.jsonc"
{
  "$schema": "https://nanocode.ai/config.json",
  "provider": {
    "helicone": {
...
```json title="nanogpt.json" "llama.cpp" {5, 6, 8, 10-15}
{
  "$schema": "https://nanocode.ai/config.json",
  "provider": {
    "llama.cpp": {
...
```json title="nanogpt.json" "lmstudio" {5, 6, 8, 10-14}
{
  "$schema": "https://nanocode.ai/config.json",
  "provider": {
    "lmstudio": {
...
```json title="nanogpt.json" "ollama" {5, 6, 8, 10-14}
{
  "$schema": "https://nanocode.ai/config.json",
  "provider": {
    "ollama": {
...
3. Enter your API key for the provider.
   ...
   ┌  Add credential
   │
   ▲  This only stores a credential for myprovider - you will need to configure it in nanogpt.json, check the docs for examples.
   │
   ◇  Enter your API key
   │  sk-...
   └
...
4. Create or update your `nanogpt.json` file in your project directory:

   ```json title="nanogpt.json" ""myprovider"" {5-15}
   {
     "$schema": "https://nanocode.ai/config.json",
     "provider": {
       "myprovider": {
...
```json title="nanogpt.json" {9,11,17-20}
{
  "$schema": "https://nanocode.ai/config.json",
  "provider": {
    "myprovider": {
