...
Algunos modelos deben habilitarse manualmente en su [GitHub configuración del copiloto](https://docs.github.com/en/copilot/how-tos/use-models/configure-access-to-models#setup-for-individual-use).
:::
