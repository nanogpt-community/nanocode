...
Si tiene `NANOGPT_PORT` configurado en su entorno, la aplicación de escritorio intentará usar ese puerto para el servidor local.

- Desarme `NANOGPT_PORT` (o elija un puerto libre) y reinicie.
