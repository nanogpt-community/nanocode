...
3. **Configuración personalizada** (`NANOGPT_CONFIG` env var): anulaciones personalizadas
...
6. **Configuración en línea** (`NANOGPT_CONFIG_CONTENT` env var): anulaciones del tiempo de ejecución
...
Especifique una ruta de archivo de configuración personalizada utilizando la variable de entorno `NANOGPT_CONFIG`.
...
Especifique un directorio de configuración personalizado usando `NANOGPT_CONFIG_DIR`
