...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Programe trabajos recurrentes usando launchd (Mac) o systemd (Linux) con sintaxis cron                                      |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar OpenCode a través de @nanogpt/sdk              |
...
| [OpenWork](https://github.com/different/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por OpenCode            |
