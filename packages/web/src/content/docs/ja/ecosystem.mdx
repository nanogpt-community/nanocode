...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | launchd (Mac) または systemd (Linux) を cron 構文で使用して、定期的なジョブをスケジュールする                         |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @nanogpt/sdk 経由で OpenCode を使用するための Vercel AI SDK プロバイダー     |
...
| [OpenWork](https://github.com/different/openwork)                                       | OpenCode を利用した、Claude Cowork に代わるオープンソース                        |
