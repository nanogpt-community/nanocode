...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Zaplanuj powtarzające się zadania, używając launchd (Mac) lub systemd (Linux) ze składaną cron                        |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Stosowanie Vercel AI SDK do użytku z opencode poprzez @nanogpt/sdk      |
...
| [OpenWork](https://github.com/different/openwork)                                       | Alternatywa typu open source dla Claude Cowork, obsługa przez opencode      |
