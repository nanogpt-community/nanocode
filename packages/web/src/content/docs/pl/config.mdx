...
3. **Konfiguracja niestandardowa** (`NANOGPT_CONFIG` env var) — zastosowanie zastąpienie
...
6. **Konfiguracja wbudowana** (`NANOGPT_CONFIG_CONTENT` env var) — zastąpienie środowiska wykonawczego
...
Niestandardowe rozwiązanie konfiguracyjne, różne opcje `NANOGPT_CONFIG`.
...
niestandardowy katalog konfiguracyjny za pomocą `NANOGPT_CONFIG_DIR`
