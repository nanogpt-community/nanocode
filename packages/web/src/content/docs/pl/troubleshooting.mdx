...
Jeśli w swoim środowisku masz ustawiony `NANOGPT_PORT`, aplikacja komputerowa spróbuje użyć tego portu dla serwera lokalnego.

- Rozbierz `NANOGPT_PORT` (lub wybierz wolny port) i uruchom ponownie.
