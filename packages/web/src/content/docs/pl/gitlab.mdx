   ...
   include:
     - component: $CI_SERVER_FQDN/nagyv/gitlab-opencode/opencode@2
       inputs:
         ...
         auth_json: $NANOGPT_AUTH_JSON # The variable name for your OpenCode authentication JSON
      ...
      - |
        if ! git diff --quiet || ! git diff --cached --quiet || [ --not --zero "$(git ls-files --others --exclude-standard)" ]; then
          ...
          if git diff --cached --quiet; then
            ...
            git push https://gitlab-ci-token:$GITLAB_TOKEN@$GITLAB_HOST/gl-demo-ultimate-dev-epic-17570/test-java-project.git $CI_WORKLOAD_REF
