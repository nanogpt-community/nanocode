...
- Global: `~/.config/nanogpt/mode/`
- Project: `.nanogpt/mode/`

```markdown title="~/.config/nanogpt/mode/review.md"
---
model: anthropic/claude-sonnet-4-20250514
temperature: 0.1
tools:
...
Create mode files in `.nanogpt/mode/` for project-specific modes or `~/.config/nanogpt/mode/` for global modes:

```markdown title=".nanogpt/mode/debug.md"
---
temperature: 0.1
tools:
  bash: true
...
```markdown title="~/.config/nanogpt/mode/refactor.md"
---
model: anthropic/claude-sonnet-4-20250514
temperature: 0.2
tools:
