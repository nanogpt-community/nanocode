---
title: SDK
description: Type-safe JS client for nanocode server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The nanocode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control nanocode programmatically.
...
Create an instance of nanocode:
...
You can pass a configuration object to customize behavior. The instance still picks up your `nanogpt.json`, but you can override or add configuration inline:
...
If you already have a running instance of nanocode, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@nanogpt/sdk"
```
...
const textResults = await client.find.text({
  query: { pattern: "function.*nanocode" },
})
