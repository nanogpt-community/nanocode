...
Create `.nanogpt/command/test.md`:
...
- Global: `~/.config/nanogpt/command/`
- Per-project: `.nanogpt/command/`

```markdown title="~/.config/nanogpt/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".nanogpt/command/component.md"
---
...
```md title=".nanogpt/command/create-file.md"
---
...
```md title=".nanogpt/command/analyze-coverage.md"
---
...
```md title=".nanogpt/command/review-changes.md"
---
...
```md title=".nanogpt/command/review-component.md"
---
