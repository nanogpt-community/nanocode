...
Create `.nanogpt/commands/test.md`:

```md title=".nanogpt/command/test.md"
---
...
You can add custom commands through the NanoCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your NanoCode [config](/docs/config):

```json title="nanogpt.jsonc" {4-12}
{
...
- Global: `~/.config/nanogpt/commands/`
- Per-project: `.nanogpt/commands/`

```markdown title="~/.config/nanogpt/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".nanogpt/commands/component.md"
---
...
```md title=".nanogpt/commands/create-file.md"
---
...
```md title=".nanogpt/commands/analyze-coverage.md"
---
...
```md title=".nanogpt/commands/review-changes.md"
---
...
```md title=".nanogpt/commands/review-component.md"
---
...
nanocode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
