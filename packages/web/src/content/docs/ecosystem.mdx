...
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for nanocode - a terminal-based AI coding agent  |
...
| [NanoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embedds NanoCode in Obsidian's UI           |
