...
3. **إعدادات مخصصة** (`NANOGPT_CONFIG` env var) - تجاوزات مخصصة
4. **إعدادات المشروع** (`opencode.json` داخل المشروع) - إعدادات خاصة بالمشروع
5. **أدلة `.opencode`** - الوكلاء، الأوامر، الإضافات
6. **إعدادات ضمنية** (`NANOGPT_CONFIG_CONTENT` env var) - تجاوزات وقت التشغيل
...
حدّد مسار ملف إعدادات مخصصًا باستخدام متغير البيئة `NANOGPT_CONFIG`.
...
حدّد دليل إعدادات مخصصًا باستخدام متغير البيئة `NANOGPT_CONFIG_DIR`.
