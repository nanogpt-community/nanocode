...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | جدولة مهام متكررة باستخدام launchd (Mac) أو systemd (Linux) بصياغة cron                   |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | موفر Vercel AI SDK لاستخدام OpenCode عبر @nanogpt/sdk                |
...
| [OpenWork](https://github.com/different/openwork)                                       | بديل مفتوح المصدر لـ Claude Cowork، مدعوم بـ OpenCode                    |
