...
3. **Egendefinert konfigurasjon** (`NANOGPT_CONFIG` env var) - egendefinerte overstyringer
...
6. **Inline config** (`NANOGPT_CONFIG_CONTENT` env var) - kjøretidsoverstyringer
...
Spesifiser en tilpasset konfigurasjonsfilbane ved å bruke miljøvariabelen `NANOGPT_CONFIG`.
...
Spesifiser en tilpasset konfigurasjonskatalog ved å bruke `NANOGPT_CONFIG_DIR`
