...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Planlegg gjentakende jobber ved hjelp av launchd (Mac) eller systemd (Linux) med cron-syntaks                 |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av OpenCode via @nanogpt/sdk  |
...
| [OpenWork](https://github.com/different/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av OpenCode  |
