...
:::note
Dette verktøyet er bare tilgjengelig når du bruker OpenCode-leverandøren eller når miljøvariabelen `NANOGPT_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
