...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Pianifica job ricorrenti con launchd (Mac) o systemd (Linux) usando sintassi cron                 |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare OpenCode tramite @nanogpt/sdk   |
...
| [OpenWork](https://github.com/different/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da OpenCode      |
