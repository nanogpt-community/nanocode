...
Avvia un server HTTP che espone accesso API alle funzionalità di opencode senza la TUI. Imposta `NANOGPT_SERVER_PASSWORD` per abilitare HTTP basic auth (username di default `opencode`).
...
| Variabile                                       | Tipo    | Descrizione                                |
| ----------------------------------------------- | ------- | ------------------------------------------ |
| `NANOGPT_EXPERIMENTAL`                         | boolean | Abilita tutte le funzionalità sperimentali |
...
| `NANOGPT_EXPERIMENTAL_EXA`                     | boolean | Abilita funzionalità Exa sperimentali      |
