...
3. **Benutzerdefinierte Konfiguration** (`NANOGPT_CONFIG` env var) – benutzerdefinierte Überschreibungen
...
6. **Inline-Konfiguration** (`NANOGPT_CONFIG_CONTENT` env var) – Laufzeitüberschreibungen
...
Geben Sie mithilfe der Umgebungsvariablen `NANOGPT_CONFIG` einen benutzerdefinierten Konfigurationsdateipfad an.
...
Geben Sie mit `NANOGPT_CONFIG_DIR` ein benutzerdefiniertes Konfigurationsverzeichnis an.
