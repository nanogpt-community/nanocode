...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | 使用帶有 cron 語法的 launchd (Mac) 或 systemd (Linux) 安排重複作業   |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用於通過 @nanogpt/sdk 使用 opencode |
...
| [OpenWork](https://github.com/different/openwork)                                       | Claude Cowork 的開源替代方案，由 opencode 提供支持            |
