...
:::tip
`global` 區域無需額外成本即可提高可用性並減少錯誤。使用區域端點（例如 `us-central1`）來滿足數據駐留要求。 [了解更多](https://cloud.google.com/vertex/generative/docs/partner-models/use-partner-models#regional_and_global_endpoints)
:::
