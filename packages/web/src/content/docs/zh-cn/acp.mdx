...
如果您需要传递环境变量（如 `NANOGPT_API_KEY`），请参阅 CodeCompanion.nvim 文档中的 [Configuration: Adapters](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) 了解完整信息。
