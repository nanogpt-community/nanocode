...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | 使用带 cron 语法的 launchd (Mac) 或 systemd (Linux) 安排重复作业                           |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用于通过 @nanogpt/sdk 使用 opencode |
...
| [OpenWork](https://github.com/different/openwork)                                       | Claude Cowork 的替代开源方案，由 opencode 提供支持            |
