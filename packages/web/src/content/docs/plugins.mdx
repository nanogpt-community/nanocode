...
1. `.nanogpt/plugin` directory either in your project
2. Or, globally in `~/.config/nanogpt/plugin`

---

### Basic structure

```js title=".nanogpt/plugin/example.js"
...
```js title=".nanogpt/plugin/notification.js"
...
```javascript title=".nanogpt/plugin/env-protection.js"
...
```ts title=".nanogpt/plugin/custom-tools.ts"
...
```ts title=".nanogpt/plugin/compaction.ts"
import type { Plugin } from "@nanogpt/plugin"
...
```ts title=".nanogpt/plugin/custom-compaction.ts"
import type { Plugin } from "@nanogpt/plugin"
