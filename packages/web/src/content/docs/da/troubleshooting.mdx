...
Hvis du har `NANOGPT_PORT` satt i miljøet ditt, vil skrivebordsappen prøve at bruge den porten for den lokale serveren.

- Deaktiver `NANOGPT_PORT` (eller velg en ledig port) og start på nytt.
