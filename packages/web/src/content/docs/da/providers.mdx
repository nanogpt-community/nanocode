...
Nogle modeller må aktiveres manuelt i [GitHub Copilot-innstillingene](https://docs.github.com/en/copilot/how-tos/use-models/configure-access-to-models#setup-for-individual-use).
:::
...
:::tip
`global`-regionen forbedrer tilgængeligheten og reduserer feil uten ekstra kostnad. Brug regionale endepunkter (f.eks. `us-central1`) for krav til dataopphold. [Finn ut mer](https://cloud.google.com/vertex/generative/docs/partner-models/use-partner-models#regional_and_global_endpoints)
:::
