...
Ortamda `NANOGPT_PORT` ayarliysa desktop uygulamasi yerel sunucu icin o portu kullanmaya calisir.

- `NANOGPT_PORT` degerini kaldirin (veya bos bir port secin) ve yeniden baslatin
