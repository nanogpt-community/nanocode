...
Bazı modellerin [GitHub Copilot settings](https://docs.github.com/en/copilot/how-tos/use-models/configure-access-to-models#setup-for-individual-use)'da manuel olarak etkinleştirilmesi gerekir.
:::
