...
| [opencode-scheduler](https://github.com/different/opencode-scheduler)                                  | Cron sözdizimi ile launchd (Mac) veya systemd (Linux) kullanarak yinelenen işleri planlayın                                    |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @nanogpt/sdk aracılığıyla opencode'u kullanmak için Vercel AI SDK sağlayıcısı |
...
| [OpenWork](https://github.com/different/openwork)                                       | opencode tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif     |
