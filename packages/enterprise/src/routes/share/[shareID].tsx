import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@nanogpt/sdk/v2"
...
const ClientOnlyDiff = clientOnly(() => import("@nanogpt/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@nanogpt/ui/code").then((m) => ({ default: m.Code })))
