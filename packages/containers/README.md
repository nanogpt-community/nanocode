...
```
REGISTRY=ghcr.io/nanogpt-community TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/nanogpt-community TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/nanogpt-community/build/bun-node:24.04
```
