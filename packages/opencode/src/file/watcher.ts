...
export namespace FileWatcher {
  ...
  export class Service extends ServiceMap.Service<Service, {}>()("@nanogpt/FileWatcher") {}

  export const layer = Layer.effect(
    Service,
    Effect.gen(function* () {
      const instance = yield* InstanceContext
      if (yield* Flag.NANOGPT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
      ...
      if (yield* Flag.NANOGPT_EXPERIMENTAL_FILEWATCHER) {
