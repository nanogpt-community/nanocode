...
const TIPS = [
  ...
  "Create {highlight}nanocode.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/nanocode/nanocode.json{/highlight} for global config",
