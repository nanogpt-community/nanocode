...
const TIPS = [
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.nanocode/tool/{/highlight} to define new LLM tools",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/sst/nanocode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with NanoGPT for curated, tested models",
