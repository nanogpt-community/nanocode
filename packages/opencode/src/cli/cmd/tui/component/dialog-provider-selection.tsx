...
export function DialogProviderSelection(props: { modelId: string }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const dir = (sdk as any).directory ?? process.cwd()
            if ((sdk as any).directory) {
                headers["x-opencode-directory"] = (sdk as any).directory
            } else {
            ...
            const modelRes = await fetch(`${sdk.url}/api/models/${encodeURIComponent(props.modelId)}/providers`, { headers })
