export const TIPS = [
  ...
  "Create {highlight}nanogpt.json{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/nanogpt/nanogpt.json{/highlight} for global config.",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.nanogpt/command/{/highlight} to define reusable custom prompts.",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  "Add {highlight}.md{/highlight} files to {highlight}.nanogpt/agent/{/highlight} for specialized AI personas.",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.nanogpt/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.nanogpt/plugin/{/highlight} for event hooks.",
  ...
  "Create JSON theme files in {highlight}.nanogpt/themes/{/highlight} directory.",
