export const TIPS = [
  ...
  "Type {highlight}/{/highlight} in the input box to see available commands.",
  "Try {highlight}/help{/highlight} to learn about available commands.",
  ...
  "See {highlight}https://nanocode.com/docs/tools{/highlight} for tool documentation.",
