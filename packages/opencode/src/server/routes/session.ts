  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all NanoCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific NanoCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new NanoCode session for interacting with AI assistants and managing conversations.",
