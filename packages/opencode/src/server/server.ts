...
export namespace Server {
  ...
  export const App: () => Hono = lazy(
    () =>
      // @ts-expect-error Type instantiation is excessively deep - expected for long route chains
      app
        .onError((err, c) => {
          log.error("failed", {
            error: err,
        ...
        .route("/api", NanogptRoute)
        .get(
          "/account",
          describeRoute({
            summary: "Get NanoGPT account info",
            description: "Retrieve account balance and subscription usage from NanoGPT API.",
