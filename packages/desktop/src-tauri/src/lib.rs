...
use crate::cli::{CommandChild, sqlite_migration::SqliteMigrationProgress, sync_cli};
use crate::constants::*;
...
async fn initialize(app: AppHandle) {
    ...
    let needs_sqlite_migration = option_env!("NANOGPT_SQLITE").is_some() && !sqlite_file_exists();
