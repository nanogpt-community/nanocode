export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'NanoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'NanoCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.error.serverStartFailed.title": "Échec du démarrage d'NanoCode",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur NanoCode local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}
