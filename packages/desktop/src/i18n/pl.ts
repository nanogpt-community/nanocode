export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji NanoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} NanoCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić NanoCode",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera NanoCode. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
