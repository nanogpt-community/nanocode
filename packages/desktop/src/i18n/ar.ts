export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من NanoCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من NanoCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.error.serverStartFailed.title": "فشل تشغيل NanoCode",
  "desktop.error.serverStartFailed.description":
    "تعذر بدء تشغيل خادم NanoCode المحلي. أعد تشغيل التطبيق، أو تحقق من إعدادات الشبكة (VPN/proxy) وحاول مرة أخرى.",
}
