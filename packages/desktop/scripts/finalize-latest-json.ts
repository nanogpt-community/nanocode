...
const releaseId = process.env.NANOGPT_RELEASE
if (!releaseId) throw new Error("NANOGPT_RELEASE is required")

const version = process.env.NANOGPT_VERSION
if (!releaseId) throw new Error("NANOGPT_VERSION is required")
...
const dir = process.env.RUNNER_TEMP ?? "@nanogpt/tmp"
