...
import SnippetIntro from "@nanogpt/snippets/snippet-intro.mdx"
...
import MySnippet from "@nanogpt/snippets/path/to/my-snippet.mdx"
...
import { myName, myObject } from "@nanogpt/snippets/path/to/custom-variables.mdx"
...
import { MyComponent } from "@nanogpt/snippets/custom-component.mdx"
