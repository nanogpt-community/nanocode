...
/**
 * Server configuration for nanocode serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: nanocode.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://nanocode.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://nanocode.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
...
export type ModelsProvidersData = {
  body?: never
  path: {
    id: string
  }
...
export type ModelsProvidersError = ModelsProvidersErrors[keyof ModelsProvidersErrors]

export type ModelsProvidersResponses = {
  /**
   * Providers list
   */
  200: {
...
export type ModelsProvidersResponse = ModelsProvidersResponses[keyof ModelsProvidersResponses]

export type UserProviderPreferencesDeleteData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type UserProviderPreferencesGetData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type UserProviderPreferencesGetResponse =
  UserProviderPreferencesGetResponses[keyof UserProviderPreferencesGetResponses]

export type UserProviderPreferencesUpdateData = {
  body?: {
    preferredProviders?: Array<string>
    excludedProviders?: Array<string>
    enableFallback?: boolean
...
export type UserProviderPreferencesUpdateError =
  UserProviderPreferencesUpdateErrors[keyof UserProviderPreferencesUpdateErrors]

export type UserProviderPreferencesUpdateResponses = {
  /**
   * Updated preferences
   */
  200: unknown
