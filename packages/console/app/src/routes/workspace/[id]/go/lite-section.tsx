...
import { Database, eq, and, isNull } from "@nanogpt/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@nanogpt/console-core/schema/billing.sql.js"
import { Actor } from "@nanogpt/console-core/actor.js"
import { Subscription } from "@nanogpt/console-core/subscription.js"
import { LiteData } from "@nanogpt/console-core/lite.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("@nanogpt/docs/providers/#opencode-go")} target="_blank" rel="noopener noreferrer">
