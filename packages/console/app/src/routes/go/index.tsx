...
export default function Home() {
  ...
  const subscribeUrl = createMemo(() => (workspaceID() ? `/workspace/${workspaceID()}/go` : "@nanogpt/auth"))
  const i18n = useI18n()
  ...
  return (
    <main data-page="go">
      ...
      <LocaleLinks path="@nanogpt/go" />
      <Meta property="og:type" content="website" />
      <Meta property="og:url" content={`${config.baseUrl}${language.route("@nanogpt/go")}`} />
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="comparison">
            <LimitsGraph href={language.route("@nanogpt/docs/go/#usage-limits")} />
          </section>
            ...
            <ul>
              <li>
                ...
                <div>
                  ...
                  <a href={language.route("@nanogpt/docs/go/#how-it-works")} title={i18n.t("go.how.step1.link")}>
              ...
              <li>
                ...
                <div>
                  ...
                  <a href={language.route("@nanogpt/docs/go/#pricing")}>{i18n.t("go.how.step2.link")}</a>{" "}
            ...
            <ul>
              ...
              <li>
                <Faq question={i18n.t("go.faq.q4")}>
                  ...
                  <a href={language.route("@nanogpt/docs/go/#pricing")}>{i18n.t("go.faq.a4.p1.pricingLink")}</a>{" "}
