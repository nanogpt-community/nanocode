import { useFilteredList } from "@nanogpt/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { createOpencodeClient, type Message, type Part } from "@nanogpt/sdk/v2/client"
...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const handleSubmit = async (event: Event) => {
    ...
    const model = {
      ...
      ...(preferredProviders.length > 0 ? { headers: { "X-Provider": preferredProviders[0] } } : {}),
    }
