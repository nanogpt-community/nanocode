...
import { type Message, type Session, type TextPart, type UserMessage } from "@nanogpt/sdk/v2/client"
import { For, Match, Show, Switch, createMemo, onCleanup, type Accessor, type JSX } from "solid-js"
import { agentColor } from "@/utils/agent"

const NANOGPT_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === NANOGPT_PROJECT_ID ? "https://opencode.ai/favicon.svg" : props.project.icon?.override
          }
