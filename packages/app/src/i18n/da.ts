export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NanoCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i NanoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NanoCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i NanoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i NanoCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i nanocode.json",
  ...
  "dialog.server.description": "Skift hvilken NanoCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af NanoCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NanoCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (nanocode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NanoCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NanoCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NanoCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan NanoCode ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan NanoCode er temabestemt.",
