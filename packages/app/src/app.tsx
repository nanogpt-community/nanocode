...
declare global {
  interface Window {
    __NANOGPT__?: { updaterEnabled?: boolean; serverPassword?: string; deepLinks?: string[]; wsl?: boolean }
  }
}
...
const resolveDefaultServerUrl = (props: {
  ...
  if (props.hostname.includes("nanocode.ai")) return "http://localhost:4096"
...
export function AppInterface(props: { defaultUrl?: string; children?: JSX.Element; isSidecar?: boolean }) {
  ...
  const defaultServerUrl = resolveDefaultServerUrl({
    ...
    devHost: import.meta.env.VITE_NANOGPT_SERVER_HOST,
    devPort: import.meta.env.VITE_NANOGPT_SERVER_PORT,
  })
